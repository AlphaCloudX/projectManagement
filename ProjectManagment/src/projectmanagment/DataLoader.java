        ...
        try {
            ...
            while (sc.hasNextLine()) {
                ...
                if (line.contains("[Q]")) {
                    ...
                    data.add(new Question(line.replace("[Q] ", "")));
                    ...
                    for (int i = 0; i < WRONGANSWERSPERQUESTION + CORRECTANSWERPERQUESTION + NOTEPERQUESTION; i++) {
                        ...
                        if (line.contains("[WA] ")) {
                            ...
                            Question updatedQuestion = findAvailableSlot(data.get(arrayPosition), line.replace("[WA] ", ""));
                            ...
                            data.get(arrayPosition).setTrueAns(line.replace("[A] ", ""));

                            //Check if it contains 1 note
                        } else if (line.contains("[N] ")) {
                            _notePerQuestion--;
                            data.get(arrayPosition).setFeedback(line.replace("[N] ", ""));
                        }
                    }
